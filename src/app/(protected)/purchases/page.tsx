...
export default function PurchasesPage() {
  ...
  return (
    <section className="space-y-6 page-shell">
      <div>
        <h1 className="text-2xl font-semibold page-title">{t("purchases.title")}</h1>
      ...
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
        ...
        >
          ...
          <p className="mt-2 text-sm text-muted page-subtitle">{t("purchases.vendorsCardDescription")}</p>
        </Link>
        <Link
        ...
        >
          ...
          <p className="mt-2 text-sm text-muted page-subtitle">{t("purchases.billsCardDescription")}</p>
        </Link>
        <Link
